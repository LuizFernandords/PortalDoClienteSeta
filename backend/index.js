...
app.post('/getValidacaoCpfRedefinicao/',db.getValidacaoCpfRedefinicao)
app.post('/getRedefinicaoEmailCliente/',db.getRedefinicaoEmailCliente)
app.post('/getRedefinicaoCodigoCliente/',db.getRedefinicaoCodigoCliente)
app.post('/getRedefinicaoNovaSenhaCliente/',db.getRedefinicaoNovaSenhaCliente)

...
const Faturas = () => {
    ...
    return( 
    <>
    <span className="Label-title">Faturas</span>
    <span className="Label-subtitle">Aqui você encontra as suas faturas em aberto. Utilize os filtros para navegar entre elas</span>
    ...
    <div className='panel-totais'>
      ...
      minimumFractionDigits: 2
        ...
        <span className="title-juros">Juros/Acréscimos pelo Portal: R$ {jurostotal.toLocaleString('pt-BR', {
        currency: 'BRL',
        minimumFractionDigits: 2
      })} 
</span>
    ...
    <Modal show={show} onHide={handleClose} >
        ...
        <p>Juros Pagamento pelo Portal: R$ {selectedFatura.juros}</p>

...
const Financeiro = () => {
    ...
    return( 
    <>
    <span className="Label-title">Histórico Financeiro</span>
    <span className="Label-subtitle">Aqui você encontra o seu histórico financeiro, com os valores pagos referente as suas faturas.</span>
    ...
    <div className='panel-totaisFinanceiro'>
      <span className="title-total">Total: R$ {formatamoeda(valorTotal)}
    </span>
      {
        faturasAcrescimos.map((ac)=>
          <span className="title-juros">Juros/Acréscimos: R$ {formatamoeda(parseFloat(ac.acrescimo))} </span>
    )
      }
    {
        faturasDescontos.map((dd)=>
        <span className="title-juros">Descontos: R$ {formatamoeda(parseFloat(dd.desconto))} </span>
    )
      }
    ...
    <Modal show={show} onHide={handleClose} >
        <Modal.Header closeButton>
          <Modal.Title align="center">Baixa de Título</Modal.Title>
        </Modal.Header>
        <Modal.Body>

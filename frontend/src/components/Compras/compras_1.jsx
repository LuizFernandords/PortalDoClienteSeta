...
const Compras = () => {
    ...
    const columns = [
        ...
        },
        {
            name: "Total",
            sortable: true,
            selector: (row) => formatamoeda(parseFloat(row.total)),
    ...
    return( 
    <>
    <span className="Label-titlecompras">Histórico de Compras</span>
    <span className="Label-subtitlecompras">Aqui você encontra as suas compras realizadas. Clique nos três pontinhos para visualizar o detalhamento.</span>
    ...
    <span className="title-totalCompras">Total: R$ {formatamoeda(valorTotal)}
     </span>
    </div>
            ...
            <tbody>
            {
                selectedProdutos.map((produtos)=>
                    <tr>
                      ...
                      <td>{produtos.qtde}</td>
                      <td>{formatamoeda(produtos.total)}</td>
                      <td>{formatamoeda(produtos.desconto)}</td>
                      <td>{formatamoeda(produtos.unitario)}</td>
                    </tr>
                )
              } 
            </tbody>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>{formatamoeda(selectedRow.total)}</td>
      <td>{formatamoeda(selectedRow.subtotal)}</td>
      <td>{selectedRow.itens}</td>
      <td>{formatamoeda(selectedRow.avista)}</td>
      <td>{formatamoeda(selectedRow.aprazo)}</td>
    </tr>
  </tbody>
</table>
<br/>
  ...
  <tbody>
    {
      ...
      <tr>
        ...
        <td>{formatamoeda(financeiro.valor)}</td>
      </tr>
  )
    }
  </tbody>
